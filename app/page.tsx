...
export default function ProductFlowAI() {
  ...
  const BackButton = () => (
    <button 
      onClick={goBack}
      style={{ 
        marginBottom: '20px', padding: '8px 15px', backgroundColor: 'transparent', 
        color: '#facc15', border: '2px solid #facc15', fontWeight: '900', 
  ...
  const ToolCard = ({ title, desc, tag, url, isComingSoon = false }: any) => (
    <div style={{ backgroundColor: '#111', border: '2px solid white', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <button 
        ...
        style={{ 
          marginTop: '15px', backgroundColor: isComingSoon ? '#333' : 'white', 
          color: isComingSoon ? '#777' : 'black', padding: '10px', fontWeight: '900', 
          border: 'none', cursor: isComingSoon ? 'default' : 'pointer', fontSize: '12px' 
        }}
      >
                ...
                {!padResult ? (
                  ...
                  <div style={{ marginTop: '20px', border: '4px solid #facc15', padding: '30px', textAlign: 'left' }}>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                      <button onClick={() => {setPadInput(""); setPadResult(null);}} style={{ padding: '10px 20px', background: 'white', color: 'black', fontWeight: '900', cursor: 'pointer' }}>START OVER</button>
              ...
              <div style={{ border: '4px solid #facc15', padding: '30px', backgroundColor: '#111' }}>
                ...
                {coachStep === 1 && (
                  <div style={{ marginTop: '20px' }}>
                    ...
                    <button onClick={() => {
                      setCoachDiagnosis({ summary: "Execution bottleneck identified.", nextStep: "Implement Flow State 90.", toolName: "FLOW STATE 90", toolLink: PRODUCTS.FLOW90 });
                      setCoachStep(2);
                    }} style={{ width: '100%', padding: '15px', background: '#facc15', fontWeight: '900', border: 'none', cursor: 'pointer', marginTop: '10px' }}>ANALYZE</button>
                  </div>
                )}
            ...
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
              ...
              {!requestSubmitted ? (
                ...
                <div style={{ border: '4px solid #facc15', padding: '40px', textAlign: 'center' }}>
                  <h2>SENT</h2>
                  <button onClick={() => setRequestSubmitted(false)} style={{ marginTop: '20px', padding: '10px 20px', background: 'white', fontWeight: '900' }}>NEW REQUEST</button>
                </div>
              )}
            </div>
          )}
